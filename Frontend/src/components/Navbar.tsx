...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-50">
      {/* Enhanced glass morphism background with animated gradient border */}
      <div
        className="absolute inset-0 bg-dark-deeper/60 backdrop-blur-xl border-b border-primary/20 
                    before:absolute before:inset-0 before:bg-gradient-to-r before:from-primary/20 before:via-secondary/20 before:to-primary/20 
        ...
        <div className="flex items-center justify-between h-20 px-6 sm:px-8 lg:px-10">
          ...
          >
            <Link to="/" className="flex items-center group">
              ...
              />
              <motion.span
                className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-primary via-primary-light to-secondary bg-clip-text text-transparent"
            ...
            {navItems.map((item, i) => (
              ...
              >
                <Link
                  ...
                  className="text-white text-sm font-medium relative group py-2 px-4"
          ...
          <div className="hidden md:flex items-center space-x-3 flex-1 justify-end">
            <motion.div className="relative group" whileHover={{ scale: 1.02 }}>
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-secondary via-primary to-secondary opacity-0 
              ...
              {/* Dropdown menu */}
              <div
                className="absolute right-0 mt-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible 
          ...
          >
            <div className="px-6 py-5 space-y-3">
              ...
              <div className="pt-4 space-y-2">
                <Link
                  to="/profile"
                  className="w-full py-2.5 px-4 bg-gradient-to-r from-primary to-secondary rounded-md text-sm font-medium text-white shadow-lg flex items-center justify-center gap-2"
                >
                  <span>Profile</span>
                  <svg
                    className="w-5 h-5"
                ...
                <Link
                  to="/profile/settings"
                  className="w-full py-2.5 px-4 text-white hover:text-white text-sm font-medium transition-all rounded-md hover:bg-white/10 flex items-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
